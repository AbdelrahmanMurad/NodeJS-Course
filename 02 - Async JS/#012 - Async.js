 ...
 * --- If there is a hold or problem in a line of the code, the program will stop executing, until it solve it.
...
/**
 * *Async process & non-blocking operations:
 *  1- Timer.
 *  2- long-time process.
 *  3- I/O operations (files, DB, API's).
 *      - I/O operations means => Read/Write operations.
 * 4- async word. 
 * =================================================================
 * 1&2&3 => Automatic.
 * 4 => not automatic.
